	...
	<div>
        <el-button-group>
			<el-tooltip class="item" effect="dark" :content="hsz ? '正常数据' : '回收站'" placement="top">
                <el-button v-if="hsz_status" :icon="!hsz ? 'el-icon-delete' : 'el-icon-s-grid'" @click="toggleHszList" size="small"></el-button>
            </el-tooltip>
			...
			<el-tooltip class="item" effect="dark" :content="'打印'" placement="top">
				<el-button class="hidden-sm-and-down"  icon="el-icon-printer" size="small" @click="printer"></el-button>
			</el-tooltip>
        </el-button-group>
    </div>
	`
...
Vue.component('SearchTool', {
    ...
    methods: {
        refesh_list() {
			this.$emit('update:page_data', {page:1,total:this.page_data.total})
			this.$emit('refesh_list')
        },
        reset(){
